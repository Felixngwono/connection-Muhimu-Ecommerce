...
urlpatterns = [
    ...
    path('customer_product', views.customer_products_view,name='customer_product'),
    path('customer-add-product', views.customer_add_product_view,name='customer-add-product'),
